...
if "SKIP":
    ...
    def model_to_circuit_rust(model: TwoLayerSkip, input: t.Tensor) -> rc.Add:
        ...
        first = make_linear_rust(
            rc.Array(model.first.weight.clone(), name="first_w"),
            rc.Array(model.first.bias.clone(), name="first_b"),
            input_arr,
            name="first",
        )
        return make_linear_rust(
            rc.Array(model.last.weight.clone(), name="last_w"),
            rc.Array(model.last.bias.clone(), name="last_b"),
            rc.Add(
